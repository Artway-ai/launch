...
env_args_mapping = {
    'POD_IP': 'host',
    f'{ENV_PREFIX}MASTER': 'master',
    f'{ENV_PREFIX}DEVICES': 'devices',
    f'{ENV_PREFIX}NNODES': 'nnodes',
    f'{ENV_PREFIX}MODE': 'mode',
    f'{ENV_PREFIX}LOG_LEVEL': 'log_level',
    f'{ENV_PREFIX}NPROC_PER_NODE': 'nproc_per_node',
    f'{ENV_PREFIX}JOB_ID': 'job_id',
    f'{ENV_PREFIX}RANK': 'rank',
    f'{ENV_PREFIX}LOG_DIR': 'log_dir',
    f'{ENV_PREFIX}MAX_RESTART': 'max_restart',
    f'{ENV_PREFIX}ELASTIC_LEVEL': 'elastic_level',
    f'{ENV_PREFIX}ELASTIC_TIMEOUT': 'elastic_timeout',
    f'{ENV_PREFIX}SERVER_NUM': 'server_num',
    f'{ENV_PREFIX}TRAINER_NUM': 'trainer_num',
    f'{ENV_PREFIX}SERVERS_ENDPOINTS': 'servers',
    f'{ENV_PREFIX}TRAINERS_ENDPOINTS': 'trainers',
    f'{ENV_PREFIX}GLOO_PORT': 'gloo_port',
    f'{ENV_PREFIX}WITH_GLOO': 'with_gloo',
}
